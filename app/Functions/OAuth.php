...
//Performing validations
        ...
        */
        $consumer_key = 'gz3L5qDVh6RrEPwheQt+4CBHTVduzst/';//Register a merchant account on
                        //demo.pesapal.com and use the merchant key for testing.
                        //When you are ready to go live make sure you change the key to the live account
                        //registered on www.pesapal.com!
        $consumer_secret = 'PkNcRWkj43msCFbIkIgzBKacivk=';// Use the secret from your test
        ...
        $desc = $request->input('description'); $_POST['description'];
        $type = 'MERCHANT'; //$_POST['type']; //default value = MERCHANT
        $reference = '001'; //$_POST['reference'];//unique order id of the transaction, generated by merchant
        $first_name = $request->input('first_name');
        $last_name = $request->input('last_name');
        $email = $request->input('email');
		
        $phonenumber = $request->input('phone_contact');//ONE of email or phonenumber is required
        ...
        $callback_url = 'http://127.0.0.1:8000/payment_status_page'; //redirect url, the page that will handle the response from pesapal.
